...
public class VirtualMemoryBenchmark implements iBenchmark {
    ...
    public void run(Object... options) {
        ...
        try {
            ...
            core = new MemoryMapper("/home/lucas/000_core", fileSize);
            ...
            double speed = (fileSize / 1024 / 1024L)/time1; /* 3. fileSize/time [MB/s] */

            result = "\nWrote " + (fileSize / 1024 / 1024L)
                    + " MB to virtual memory at " + String.format("%.2f", speed) + " MB/s";
            ...
            time = timer.stop();
            time1 = time/1000000000.0;
            speed = (fileSize / 1024 / 1024L)/time1;

            // append to previous 'result' string
            result += "\nRead " + (fileSize / 1024 / 1024L)
                    + " MB from virtual memory at " + String.format("%.2f", speed)+ " MB/s";
